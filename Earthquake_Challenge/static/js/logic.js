...
console.log("working");
var API_KEY = "pk.eyJ1IjoiZGFuZXdoaXR0ZWQiLCJhIjoiY2tlaG9ma3Y3MHg2MjJ5cWRlMm1ncXJwcCJ9.UHvJPPaLuDv38QAquWUlOw";
...
var map = L.map("mapid", {
  ...
  zoom: 3,
  layers: [streets, dark, satellitemap, outdoors]
});
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson", function(data) {
  ...
  // magnitude of the earthquake calculates the color and radius.
  ...
  // color of the marker is based on the magnitude of the earthquake.
  ...
  // add a GeoJSON layer to map once the file is loaded.
  L.geoJson(data, {
    // turn each feature into a circleMarker on the map.
    pointToLayer: function(feature, latlng) {
      return L.circleMarker(latlng);
    },
    // set the style for circleMarker using styleInfo function.
    style: styleInfo,
